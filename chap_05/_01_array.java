...
public class _01_Array {
	public static void main(String[] args) {
		...
		String coffeeRache1= "카페모카";
		String coffeeChandler="라떼";
		String coffeeMonica= "카푸치노";
		
		System.out.println(coffeeRoss + "하나");
		System.out.println(coffeeRache1 + "하나");
		System.out.println(coffeeChandler + "하나");
		System.out.println(coffeeMonica + "하나");
		System.out.println("주세요!");
		
		// 배열 선언 첫번째 방법
		// 데이터타입 변수 이름 = new 데이터타입[배열의 크기];
		// 배열은 선언때 크리가 무조건 정해져야 한다!!
...
//		String coffees2[] = new String[4];
		...
		System.out.println("내노으세요!!");
		
		// 배열 선언 및 할당시 주의점!
		// 배열의 데이터타입과 이름만 선언은 가능함!
		// 단, 타입과 이름만으로 선언한 경우 값을 할당할 때, new String[] 를 생략할 수 없다!
		String[] coffees6;
		// coffees6 = {"아메리카노", "카페모카", "라떼", "카푸치노"};
